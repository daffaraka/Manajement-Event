...
@section('title', 'Edit Narasumber Kegiatan')

@section('content_header')
<h1 class="m-0 text-dark text-center">Edit Narasumber Kegiatan</h1>
@stop
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="kota" id="kota" placeholeder="Kota" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="provinsi" id="provinsi" placeholeder="Provinsi" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="kelamin" id="kelamin" placeholeder="Jenis Kelamin" required>
