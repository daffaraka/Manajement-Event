...
@section('title', 'Edit PIU')

@section('content_header')
    <h1 class="m-0 text-dark text-center">Edit PIU</h1>
@stop
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="exampleInputName"
                                placeholder="Nama PIU" name="name" value="{{ $user->name ?? old('name') }}">
                            @error('name')
                    ...
                    <div class="card-footer">
                        ...
                        <a href="/piu" class="btn btn-primary">
                            Batal
                        </a>
                    </div>
                </div>
