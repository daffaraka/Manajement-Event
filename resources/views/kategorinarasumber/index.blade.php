...
@section('title', 'Kategori Narasumber')

@section('content_header')
    <h1>Kategori Narasumber</h1>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Kamu yakin ingin menghapus data Kategori Narasumber?</p>
                </div>
                <div class="modal-footer bg-whitesmoke br">
                    <button type="button" class="btn btn-secondary btn" data-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-danger btn" id="tombol-hapus">Hapus
    ...
    $(document).ready(function () {
        $('#kategori_narasumber').DataTable({
            ...
            $('body').on('click', '.edit-post', function () {
                var data_id = $(this).data('id_kategori');
                $.get('kategorinarasumber/' + data_id + '/edit', function (data) {
                    $('#modal-judul').html("Edit Kategori Narasumber");
            ...
            $('#tombol-hapus').click(function () {
                $.ajax({
                    url: 'kategorinarasumber/' + dataId + '/delete',
                    type: 'get',
                    beforeSend: function () {
